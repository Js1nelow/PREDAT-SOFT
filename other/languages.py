...
languages = {
    "ru": {
        ...
        "dep_action": "💸 Внести депозит",
        "welcome": "Добро пожаловать, <b>{first_name}!</b>\n\nДля использования бота - <b>подпишись</b> на наш канал🤝",
        "welcome_message": """<b>Главное меню:</b>""",
        "register_info": f"""<b>⚠️ Ошибка: Регистрация не пройдена!</b>

<b>✦ При регистрации обязательно вводите промокод - {PROMO}</b>

<b>● После завершения регистрации, Вам автоматически придет уведомление в бота.</b>
""",
        "instruction_info": """<b>Для обучения бота было сыграно 🎰30,000 игр.

В настоящее время пользователи бота успешно генерируют 15-25% от своего 💸 капитала ежедневно!</b>

Бот все еще проходит проверки и исправления! Точность бота составляет 99.9%!
Чтобы достичь максимальной прибыли, следуйте этой инструкции:

 1. <b>Зарегистрируйтесь в букмекерской конторе </b> <a href='{ref_url}'>1WIN</a> 
...
""",
        ...
        "success_registration": """<b>Поздравляем с успешной регистрацией! 🥳</b>

<b>🌐Шаг 2</b> - Внеси первый депозит.

✦ Чем больше депозит, тем больше <b>УРОВЕНЬ</b> в боте, а чем больше уровень в боте, тем большее количество сигналов с высокой вероятностью проходимости сигнала ты будешь получать.

● После успешного пополнения баланса, Вам автоматически придет <b>уведомление</b> в бота.""",
        "enter_new_ref": "Отправьте новую ссылку",
        "deposit_verified": "✅ Ваш депозит успешно подтвержден! Доступ к сигналам открыт.",
        "deposit_required": "Вам нужно внести депозит!",
    ...
    "en": {
        ...
        "dep_action": "💸 Deposit",
        "success_registration": """<b>Congratulations on successful registration! 🥳</b>

<b>🌐 Step 2</b> - Make your first deposit.

✦ The higher the deposit, the higher your <b>LEVEL</b> in the bot. Higher levels allow you to receive more signals with a higher probability of success.

● After completing your first deposit, you will automatically receive a <b>notification</b> from the bot.""",

        "deposit_verified": "✅ Your deposit has been successfully verified! Access to signals is now open.",
        "deposit_required": "You need to make a deposit!",
        "welcome": "Welcome, <b>{first_name}!</b>\n\nTo use the bot, please <b>subscribe</b> to our channel🤝",
        "welcome_message": """<b>Main Menu:</b>""",
        "register_info": f"""<b>⚠️ Error: Registration not completed!</b>

<b>✦ Please enter the promo code {PROMO} during registration.</b>

<b>● Once registration is complete, you will receive an automatic notification from the bot.</b> """,
...
🟢 6. In case of an unsuccessful signal, we recommend doubling (x²) your bet to completely cover the loss with the next signal.""",
    ...
    "hi": {
        ...
        "register_info": f"""<b>⚠️ त्रुटि: पंजीकरण पूरा नहीं हुआ!</b>

<b>✦ कृपया पंजीकरण के दौरान प्रमोशनल कोड {PROMO} दर्ज करें।</b>

<b>● पंजीकरण पूरा होने के बाद, आपको स्वचालित रूप से बॉट से एक सूचना मिलेगी।</b>""",
...
""",
        ...
        "dep_action": "💸 जमा करें",
        "success_registration": """<b>सफल पंजीकरण पर बधाई! 🥳</b>

<b>🌐 चरण 2</b> - अपना पहला जमा करें।

✦ जमा जितना अधिक होगा, आपकी बॉट में <b>स्तर</b> उतना ही अधिक होगा। उच्च स्तर आपको अधिक सफल संकेत प्राप्त करने की अनुमति देता है।

● अपने पहले जमा को पूरा करने के बाद, आपको स्वचालित रूप से बॉट से एक <b>सूचना</b> प्राप्त होगी।""",
        "deposit_verified": "✅ आपकी जमा राशि सफलतापूर्वक सत्यापित कर दी गई है! सिग्नल तक पहुंच खुली है।",
        "deposit_required": "आपको जमा करना होगा!",
    ...
    "es": {
        ...
        "register_info": f"""<b>⚠️ Error: ¡Registro no completado!</b>

<b>✦ Durante el registro, ingrese el código promocional {PROMO}.</b>

<b>● Una vez completado el registro, recibirá una notificación automática del bot.</b>
""",
...
""",
        ...
        "dep_action": "💸 Depositar",
        "success_registration": """<b>¡Felicidades por tu registro exitoso! 🥳</b>

<b>🌐 Paso 2</b> - Haz tu primer depósito.

✦ Cuanto mayor sea el depósito, mayor será tu <b>NIVEL</b> en el bot, y cuanto mayor sea el nivel en el bot, más señales con alta probabilidad de éxito recibirás.

● Después de completar tu primer depósito, recibirás automáticamente una <b>notificación</b> del bot.""",
        "deposit_verified": "✅ ¡Tu depósito ha sido verificado con éxito! El acceso a las señales está abierto.",
        "deposit_required": "¡Necesitas hacer un depósito!",
    ...
    "az": {
        ...
        "register_info": f"""<b>⚠️ Xəta: Qeydiyyat tamamlanmadı!</b>

<b>✦ Qeydiyyat zamanı {PROMO} promosyon kodunu daxil edin.</b>

<b>● Qeydiyyat tamamlandıqdan sonra, siz botdan avtomatik bildiriş alacaqsınız.</b>
""",
        "instruction_info": """<b>🤖Bot OpenAI neyron şəbəkə klasterində əsaslanır və təlim keçir! 
⚜️Botu təlim etmək üçün 🎰30,000 oyun oynanıb.
...
""",
        ...
        "dep_action": "💸 Depozit qoymaq",
        "success_registration": """<b>Uğurlu qeydiyyat üçün təbrik edirik! 🥳</b>

<b>🌐 Addım 2</b> - İlk depozitinizi qoyun.

✦ Depozit nə qədər yüksəkdirsə, botda <b>SƏVİYYƏ</b> də bir o qədər yüksəkdir. Yüksək səviyyələr sizə daha yüksək uğur ehtimalı olan daha çox siqnal almanıza imkan verir.

● İlk depozitinizi tamamladıqdan sonra, sizə avtomatik olaraq botdan <b>bilmə</b> gələcək.""",
        "deposit_verified": "✅ Depozitiniz uğurla təsdiqləndi! Siqnallara giriş açıqdır.",
        "deposit_required": "Depozit etməlisiniz!",
    ...
    "pt": {
        ...
        "register_info": f"""<b>⚠️ Erro: Registro não concluído!</b>

<b>✦ Durante o registro, insira o código promocional {PROMO}.</b>

<b>● Após a conclusão do registro, você receberá uma notificação automática do bot.</b>
""",
...
""",
        ...
        "dep_action": "💸 Depositar",
        "success_registration": """<b>Parabéns pelo registro bem-sucedido! 🥳</b>

<b>🌐 Passo 2</b> - Faça seu primeiro depósito.

✦ Quanto maior o depósito, maior seu <b>NÍVEL</b> no bot, e quanto maior o nível no bot, mais sinais com alta probabilidade de sucesso você receberá.

● Após completar seu primeiro depósito, você receberá automaticamente uma <b>notificação</b> do bot.""",
        "deposit_verified": "✅ Seu depósito foi verificado com sucesso! O acesso aos sinais está aberto.",
        "deposit_required": "Você precisa fazer um depósito!",
...
<b>● Assim que o registro estiver concluído, você receberá uma notificação automática do bot.</b>
""",
        "instruction_info": """<b>🤖O bot é baseado e treinado no cluster de redes neurais da OpenAI! 
⚜️Para treinar o bot, 🎰30,000 jogos foram jogados.
...
""",
        ...
        "choose_lang": "🌐Escolher idioma",
        "dep_action": "💸 Depositar",
        "success_registration": """<b>Parabéns pela inscrição bem-sucedida! 🥳</b>

<b>🌐 Etapa 2</b> - Faça seu primeiro depósito.

✦ Quanto maior o depósito, maior seu <b>NÍVEL</b> no bot. Níveis mais altos permitem que você receba mais sinais com maior probabilidade de sucesso.
...
● Após completar seu primeiro depósito, você receberá automaticamente uma <b>notificação</b> do bot.""",
    ...
    "tr": {
        ...
        "register_info": f"""<b>⚠️ Hata: Kayıt tamamlanmadı!</b>

<b>✦ Kayıt sırasında {PROMO} promosyon kodunu girin.</b>

<b>● Kayıt tamamlandıktan sonra, botunuzdan otomatik bir bildirim alacaksınız.</b>
""",
        "instruction_info": """<b>🤖Bot, OpenAI sinir ağı kümesine dayanıyor ve eğitildi! 
⚜️Botu eğitmek için 🎰30,000 oyun oynandı.
...
""",
        ...
        "choose_lang": "🌐Dil seçin",
        "dep_action": "💸 Para yatır",
        "success_registration": """<b>Başarılı kayıt için tebrikler! 🥳</b>

<b>🌐 Adım 2</b> - İlk yatırımınızı yapın.

✦ Yatırım ne kadar yüksekse, botta <b>SEVİYE</b> o kadar yüksek olur ve botta daha yüksek bir seviyeye sahip olduğunuzda, daha fazla yüksek başarı olasılığına sahip sinyal alırsınız.

● İlk yatırımınızı tamamladıktan sonra, bottan otomatik bir <b>bildirim</b> alacaksınız.""",
        "deposit_verified": "✅ Yatırımınız başarıyla doğrulandı! Sinyallere erişim açıldı.",
        "deposit_required": "Bir depozit yapmalısınız!",
    ...
    "ar": {
        ...
        "welcome_message": """<b>Əsas menyu:</b>""",
        "register_info": f"""<b>⚠️ خطأ: لم تكتمل عملية التسجيل!</b>

<b>✦ أثناء التسجيل، يرجى إدخال الرمز الترويجي {PROMO}.</b>

<b>● بعد اكتمال التسجيل، ستتلقى إشعارًا تلقائيًا من الروبوت.</b>
""",
...
""",
        ...
        "dep_action": "💸 إيداع",
        "success_registration": """<b>تهانينا على التسجيل الناجح! 🥳</b>

<b>🌐 الخطوة 2</b> - قم بإجراء الإيداع الأول.

✦ كلما زاد الإيداع، زادت <b>مستوى</b> البوت، وكلما زاد المستوى في البوت، زادت عدد الإشارات ذات احتمالية النجاح العالية التي ستتلقاها.

● بعد إكمال إيداعك الأول، ستتلقى تلقائيًا <b>إشعارًا</b> من الروبوت.""",
        "deposit_verified": "✅ تم التحقق من إيداعك بنجاح! الوصول إلى الإشارات مفتوح.",
        "deposit_required": "يجب عليك إيداع!",
    ...
    "uz": {
        ...
        "register_info": f"""<b>⚠️ Xato: Ro'yxatdan o'tish tugamadi!</b>

<b>✦ Ro'yxatdan o'tish vaqtida {PROMO} promo-kodini kiriting.</b>

<b>● Ro'yxatdan o'tish tugagach, sizga botdan avtomatik xabar keladi.</b>
""",
        "instruction_info": """<b>🤖Bot OpenAI neyron tarmoq klasteriga asoslangan va o'qitilgan! 
⚜️Botni o'qitish uchun 🎰30,000 o'yin o'ynaldi.
...
""",
        ...
        "dep_action": "💸 Depozit qo'yish",
        "success_registration": """<b>Muvoffaqiyatli ro'yxatdan o'tganingiz bilan tabriklaymiz! 🥳</b>

<b>🌐 2-qadam</b> - Birinchi depozitingizni joylashtiring.

✦ Depozit qancha katta bo'lsa, botdagi <b>DARAJANGIZ</b> shuncha yuqori bo'ladi. Yuqori darajalar sizga yuqori muvaffaqiyat ehtimoli bilan ko'proq signal olish imkonini beradi.

● Birinchi depozitingizni tugatgandan so'ng, sizga avtomatik ravishda botdan <b>xabar</b> keladi.""",
        "deposit_verified": "✅ Sizning depozitingiz muvaffaqiyatli tasdiqlandi! Signallarga kirish ochiq.",
        "deposit_required": "Siz depozit kiritishingiz kerak!",
